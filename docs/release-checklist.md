...
- [x] 140 enstrümanlık tam-universe veri politikası ve Yahoo OHLC sanitization doğrulandı.
...
Sürüm adayı: `0.2.0`. Release artefaktları local-firsttir; model/veri dosyaları Git'e dahil
edilmez.
